...
/*Oleksii Saiun. 2020-Jul-28.  Diameter of binary tree
 * 
 * 
 * Diameter - is a number of nodes on longest path
 *
 * it can be two options
 * 1) the longest path go through a root node = then left height + right height = (root.left+root.right +1) (where [1] is a heaght of root)
